...
namespace DepthKit
{
    ...
    public class ClipEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            _depthSaturationThresholdProp = serializedObject.FindProperty("_edgeCleanup1");
            _depthBrightnessThresholdProp = serializedObject.FindProperty("_edgeCleanup2");
        ...
        void OnInspectorGUI_RendererOptions()
        {
            ...
            if (EditorGUI.EndChangeCheck() && _renderTypeProp.enumValueIndex != cachedRenderType)
            {
                if (_renderTypeProp.enumValueIndex == (int)RenderType.Simple && cachedRenderType == (int)RenderType.Hologram)
                {
