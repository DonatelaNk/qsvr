...
namespace DepthKit
{
    ...
    public class Clip : MonoBehaviour
    {
        ...
        public float _depthLuminanceFilter = 0.5f; //_depthBrightnessThreshold
        /// <summary>
        /// Set the saturation threshold for the depth texture </summary>
        [Range(0.0f,1.0f), Tooltip("Filter out depth map samples that have a saturation lower than this value. Should be as high as possible without introducing holes in the clip during playback. This helps cleanup edge artifacts")]
        public float _depthSaturationFilter = 0.5f; //_depthSaturationThreshold
        /// <summary>
        ...
        public float _triangleSizeLimit = 0.0f; //_internalEdgeThreshold
        ...
        protected void RefreshRendererValues()
        {
            ...
            else
            {
                ...
                _renderer.TextureIsExternal = false;
            }

            //set the render tweak values
            _renderer._depthPackingEpsilon      = _depthPackingEpsilon;
            _renderer._depthSaturationThreshold = _depthSaturationFilter;
            _renderer._depthBrightnessThreshold = _depthLuminanceFilter;
            _renderer._internalEdgeThreshold    = _triangleSizeLimit;
        }
